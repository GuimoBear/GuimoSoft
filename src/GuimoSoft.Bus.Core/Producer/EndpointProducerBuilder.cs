...
namespace GuimoSoft.Bus.Core.Producer
{
        ...
        where TOptions : class, new()
    {
        ...
        public TypedEndpointProducerBuilder<TOptions, TMessage> FromType<TMessage>() where TMessage : IMessage
        {
            _assemblies.TryAddAssembly(typeof(TMessage).Assembly);
            return new TypedEndpointProducerBuilder<TOptions, TMessage>(_parent, _busName, _switch, _busSerializerManager, _messageTypesCache);
        }
    }
}
